...
<p>
  Please read these Terms of Service ("Terms", "Terms of Service") carefully before using the CassetteOne
  mobile application (the "App") operated by Weelone Ltd ("us", "we", or "our").
</p>
...
<p>
  By accessing or using the App, you agree to be bound by these Terms. If you disagree with any part of the
...
<ol>
  ...
  <li>
    <p>
      You must not use the App in any way that causes, or may cause, damage to the App or impairment of the
      availability or accessibility of the App.
    </p>
  </li>
  <li>
    <p>
      You must not use the App in any way that is unlawful, illegal, fraudulent, or harmful, or in
...
<p>
  ...
  of Weelone Ltd and its licensors. The App is protected by copyright, trademark, and other laws of both
  the [Your Country] and foreign countries. Our trademarks and trade dress may not be used in connection
...
<p>
  ...
  App is provided without warranties of any kind, whether express or implied, including, but not limited
...
<ul>
  <li>By email: cassette@weelone.com</li>
  <li>By visiting this page on our website: https://cassette.one</li>
</ul>
