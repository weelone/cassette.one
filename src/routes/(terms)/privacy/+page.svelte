...
<p>
  Weelone Ltd ("we," "our," or "us") operates the CassetteOne mobile application (the "App"). This page
...
<p>
  ...
  compromised through our systems is minimized. However, please be aware that no method of electronic
